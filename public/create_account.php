...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO users (
            google_id, iss, azp, aud, email, email_verified, name, given_name, family_name,
            picture, locale, hd, nbf, iat, exp, jti, created_at, updated_at
        ) VALUES (
            :google_id, :iss, :azp, :aud, :email, :email_verified, :name, :given_name, :family_name,
            :picture, :locale, :hd, :nbf, :iat, :exp, :jti, NOW(), NOW()
        )");
    $stmt->execute([
        ':google_id' => $sub,
        ':iss' => $iss,
